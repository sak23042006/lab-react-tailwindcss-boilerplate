    ...
    <>
      <header>
        <nav className="bg-red-500 py-5 px-5 flex items-center space-x-4 justify-between">
          <div className="flex justify-evenly space-x-10 items-center">
            <div className="logo">
              <h1 className="text-black text-2xl font-bold lg:3xl hover:cursor-pointer">Kalvium</h1>
            </div>
            <div>
              <ul className="text-black flex space-x-3 justify-between">
                <li>
                  <a href="">About Us</a>
                </li>
                <li>
          ...
          <button className="py-1 bg-transparent px-4 border-black border-[1px] bg-[#000000] rounded-md text-white">
            Login
          </button>
        </nav>
      </header>
      ...
      <main className="py-5">
        <section className="px-[9.2rem]">
          <button className=" rounded-md p-2 text-white font-bold bg-black mb-5">
            Button One
          </button>
          <div
          ...
          >
            ...
            <span className="font-semibold">Kakoii!</span>
          </div>
        </section>
